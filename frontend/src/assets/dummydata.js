...
export const socialIcons = [
    { icon: FaFacebook, link: 'https://www.instagram.com/zomato/', color: '#3b5998', label: 'Facebook' },
    { icon: FaInstagram, link: 'https://www.instagram.com/zomato/', color: '#E1306C', label: 'Instagram' },
    { icon: FaXTwitter, link: 'https://www.instagram.com/zomato/', color: '#000', label: 'X' },
    { icon: FaYoutube, link: 'https://www.instagram.com/zomato/', color: '#FF0000', label: 'Youtube' },
];
